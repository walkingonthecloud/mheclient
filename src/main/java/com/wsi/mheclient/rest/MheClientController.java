...
public class MheClientController {
    ...
    @GetMapping(value = "/sendKeepAlive")
    public ResponseEntity<String> sendKeep() throws IOException, InterruptedException {
        socketClient.sendKeep();

        return new ResponseEntity<String>("KEEPALIVE successfully sent to server!",null, HttpStatus.OK);
    }
